        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseFK = table.Column<Guid>(nullable: false),
                    Created_by = table.Column<Guid>(nullable: false),
                    Updated_by = table.Column<Guid>(nullable: false),
                    Active = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(nullable: true),
                    Score = table.Column<int>(nullable: false),
                    LessonFK = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    QuestionFK = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserFK = table.Column<Guid>(nullable: false),
                    CourseFK = table.Column<Guid>(nullable: false),
                    Lesson_scoreFK = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    EnrollmentFK = table.Column<Guid>(nullable: false),
                    LessonFK = table.Column<Guid>(nullable: false),
